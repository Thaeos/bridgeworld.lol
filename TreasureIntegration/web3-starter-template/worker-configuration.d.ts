/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 06af21f3c99134a6dc7e069bef4e5c5c)
// Runtime types generated with workerd@1.20250803.0 2025-07-09 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		PUBLIC_ENVIRONMENT: string;
		SECRET: string;
		TREASURE_MARKETPLACE_ADDRESS: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ENVIRONMENT" | "SECRET">> {}
}
